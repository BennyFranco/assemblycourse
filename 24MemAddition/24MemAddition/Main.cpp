...
void MmxAddByte(void)
{
	...
	printf("\n\n Packed byte addtion - signed integers\n");
	...
	printf("\n\n Packed byte addtion - unsigned integers\n");
...
void MmxAddWords(void)
{
	...
	printf("\n\n Packed word addtion - signed integers\n");
	...
	printf("\n\n Packed word addtion - unsigned integers\n");
	printf("a: %s\n", a.ToString_i16(buff, sizeof(buff)));
	printf("b: %s\n", b.ToString_i16(buff, sizeof(buff)));
