...
{
	sprintf_s(s, len, "%4u %4u %4u %4u %4u %4u %4u %4u", u8[0], u8[1], u8[2], u8[3], u8[4], u8[5], u8[6], u8[7]);
	return s;
}
...
{
	sprintf_s(s, len, "%02X %02X %02X %02X %02X %02X %02X %02X", u8[0], u8[1], u8[2], u8[3], u8[4], u8[5], u8[6], u8[7]);
	return s;
}
